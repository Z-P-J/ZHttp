...
import com.zpj.http.parser.html.nodes.DocumentType;
import com.zpj.http.parser.html.nodes.Element;
import com.zpj.http.parser.html.nodes.Node;
import com.zpj.http.parser.html.nodes.PseudoTextElement;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.zpj.http.parser.html.nodes.Attribute> values = element.attributes().asList();
            for (com.zpj.http.parser.html.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    com.zpj.http.parser.html.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
