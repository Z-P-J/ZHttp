...
public class Parser {
    ...
    public static Document parse(Reader reader, String baseUri) {
        TreeBuilder treeBuilder = new HtmlTreeBuilder();
        return treeBuilder.parse(reader, baseUri, new Parser(treeBuilder));
    }

    public static Document parseXml(String html, String baseUri) {
