...
import com.zpj.http.parser.jsoup.nodes.DocumentType;
import com.zpj.http.parser.jsoup.nodes.Element;
import com.zpj.http.parser.jsoup.nodes.Node;
import com.zpj.http.parser.jsoup.nodes.PseudoTextElement;
import com.zpj.http.parser.jsoup.nodes.TextNode;
...
import static com.zpj.http.parser.jsoup.utils.Normalizer.lowerCase;
import static com.zpj.http.parser.jsoup.utils.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.zpj.http.parser.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.zpj.http.parser.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    com.zpj.http.parser.jsoup.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
